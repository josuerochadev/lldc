...
export default function Footer({ className = "", ...rest }: FooterProps) {
	const footerLinkBase =
		"font-semibold transition-colors hover:text-orange focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange";
		...
		>
			...
			<div className="mx-auto grid max-w-5xl gap-y-8 gap-x-12 sm:grid-cols-2">
				...
				>
					...
					<p className="pt-4 text-xs text-center sm:text-left">
						Développé&nbsp;par{" "}
						<a
