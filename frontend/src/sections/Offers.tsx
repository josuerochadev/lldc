              ...
              <FadeInUp key={offer.id} delay={index * 0.2}>
                <TiltCard>
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute inset-4 flex flex-col justify-start rounded-md bg-primary/30 px-6 py-8 text-beige shadow-lg backdrop-blur-2xl transition-all duration-500"
                      initial={false}
