	...
	return (
		<div className="mb-12 flex min-h-[100dvh] flex-1 items-center justify-center px-2">
			<CardFrame className="flex w-[90vw] max-w-[480px] flex-col items-center">
				{/* ---------- H1 com nome acessível ---------- */}
				<h1 className="mx-auto mb-4 flex justify-center">
					{/* nome lido por leitores de tela; invisível & cor neutra (não testa contraste) */}
					<span className="sr-only text-transparent">
						La Lunetterie du Coin — Accueil
					</span>

					{/* logo decorativo, mas centro visual */}
					<Logo
						aria-hidden="true"
						className="h-auto w-[clamp(150px,20vw,200px)] text-primary"
					/>
				</h1>
